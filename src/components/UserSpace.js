  ...
  return(
    <div className="user-space">
        ...
        <div className={"user-board"}>
            <div className="user-board-close">
            ...
            <div className={"board-account"} >
                <div className="board-content-wrap">
                    <div className="board-grid">
                        <a className="board-link" href="/pages/signin/login.html">
                            <img className="board-icon" src="/assets/images/header/iconsignin.svg" alt="" />
                            <span>Accedi</span>
                        </a>
                        <a className="board-link" href="/pages/signin/create.html">
                ...
                <div className="board-content-wrap">
                    ...
                    <div className="board-footer">
                        <p>
                            ...
                            <a className="boardAnchor" href="#">Aiuto EA</a>, 
                            <a href="#">Answers HQ</a> 
                            order or die 
                            <a className="boardAnchor" href="#">Forum EA</a>.
                        </p>
                    </div>
                </div>
            </div>
