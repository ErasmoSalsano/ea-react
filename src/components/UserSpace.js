  ...
  return (
    <div className="user-space"  onClick={e=>e.stopPropagation()} >
      ...
      <div className="user-bar-wrap">
        ...
        <div trigger='accountBoard' onClick={(e) => checkBoard(e)} className="user-account-icon" title="user account">
        ...
        <div trigger='helpBoard' onClick={(e) => checkBoard(e)} className="user-help-icon" title="help">
      ...
      <div className='user-board' open={userBoard} closed={start && String(!userBoard)} >
        ...
        <div className='board-help' open={helpBoard} closed={String(!helpBoard)}>
          <div className="board-content-wrap">
