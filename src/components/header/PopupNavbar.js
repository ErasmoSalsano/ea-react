export const PopupNavbar = ({Data}) => {
  ...
  const { navHidden, gamesHidden, popMenuOpen, popNavOpen, popGamesOpen, onPopNavClick } = Data;

  return (
    <div className="popup-menu-wrap" open={popMenuOpen} onClick={onPopNavClick}>
      <section className="popup-navbar-wrap" style={{display : navHidden ? 'none' : 'block'}} open={popNavOpen} onClick={(e)=>{e.stopPropagation()}}>

        <div className="top-nav">
          <img className="header-logo-esteso-nav" src="assets/images/header/ea-wordmark-network-nav-coral-bicolor.svg"
            alt="Electronics Arts logo" />
          <svg onClick={onPopNavClick} className="popup-close-icon" x="0px" y="0px" viewBox="0 0 40 40">
            <g viewBox="0 0 16 16">
              <path fillRule="evenodd" style={{ "stroke": "currentColor" }} fill="none" clipRule="evenodd"
          ...
          <ul>
            <li>
              <details className="details-1">
                <summary>
                  Giochi
                  <svg className="chevron" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                  ...
                  <ul className="inner-ul">
                    <li>
                      <details className="details-2">
                        <summary>
                          ESPLORA I GIOCHI
                          <svg className="cross" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                            {/* <!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --> */}
                            <path
                        ...
                        <div className='content'>
                          <ul className="end-ul">
                            <li><a href="/pages/games/lastgames.html">Ultimi giochi</a></li>
                            <li><a href="/pages/manteinance/mantenaince.html">Prossimamente</a></li>
                            <li><a href="/pages/games/EA-SPORTS.html">EA SPORTS</a></li>
                            <li><a href="/pages/games/freegames.html">Giochi gratuiti</a></li>
                            <li><a href="/pages/manteinance/mantenaince.html">Libreria dei giochi</a></li>
                          </ul>
                        </div>
                      </details>
                    </li>
                    <li>
                      <details className="details-2">
                        ...
                        <div className='content'>
                          <ul className="end-ul">
                            <li><a href="/pages/games/pc.html">PC</a></li>
                            <li><a href="/pages/games/ps5.html">PlayStation®5</a></li>
                            <li><a href="/pages/games/xbox.html">Xbox Series X</a></li>
                            <li><a href="/pages/manteinance/mantenaince.html">Nintendo Switch™</a></li>
                            <li><a href="/pages/manteinance/mantenaince.html">Cellulari</a></li>
                          </ul>
                        </div>
                      </details>
                    </li>
      ...
      <section className="popup-games-wrap" style={{display : gamesHidden ? 'none' : 'block'}} open={popGamesOpen} onClick={(e)=>{e.stopPropagation()}}>

        <div className="top-nav">
          <span>Tutti i giochi</span>
          <svg onClick={onPopNavClick} className="cross close-cross" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
            {/* <!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --> */}
            <path
              d="M432 256c0 17.69-14.33 32.01-32 32.01H256v144c0 17.69-14.33 31.99-32 31.99s-32-14.3-32-31.99v-144H48c-17.67 0-32-14.32-32-32.01s14.33-31.99 32-31.99H192v-144c0-17.69 14.33-32.01 32-32.01s32 14.32 32 32.01v144h144C417.7 224 432 238.3 432 256z" />
          </svg>
        ...
        <div className="popup-games">
          ...
          <div className="game-in-nav">
            <img className="game-in-nav-image"
          ...
          <div className="game-in-nav">
            <img className="game-in-nav-image"
              src="/assets/images/game/1-1-gamebox-f122-keyart-1.png.adapt.crop1x1.767p.png" alt="F1® 22" />
            <div className="game-in-nav-overlay">
              <img className="logo" alt="F1® 22 logo"
                src="https://media.contentapi.ea.com/content/dam/gin/common/logos/f122-gamebox-logo.png" />
            </div>
          </div>

          <div className="game-in-nav">
            <img className="game-in-nav-image" src="/assets/images/game/madden-23.jpg" alt="Madden 23" />
            <div className="game-in-nav-overlay">
              <img className="logo" alt="Madden 23 logo" src="/assets/images/game/madden-23-logo.svg" />
            </div>
          </div>

          <div className="game-in-nav">
            <img className="game-in-nav-image" src="/assets/images/game/apex-legends-keyart.jpg.adapt.crop1x1.767p.jpg"
              alt="Apex Legends" />
            <div className="game-in-nav-overlay">
              <img className="logo" alt="Apex Legends logo"
                src="https://media.contentapi.ea.com/content/dam/gin/common/logos/apex-legends-mono-logo.svg" />
            </div>
          </div>

          <div className="game-in-nav">
            <img className="game-in-nav-image" src="/assets/images/game/battlefield-2042-key-art.jpg.adapt.crop1x1.767p.jpg"
              alt="Battlefield 2042" />
            <div className="game-in-nav-overlay">
              <img className="logo big-logo" alt="Battlefield 2042 logo"
                src="https://media.contentapi.ea.com/content/dam/gin/common/logos/battlefield-2042-mono-logo-svg.svg" />
            </div>
          </div>

          <div className="game-in-nav">
            <img className="game-in-nav-image" src="/assets/images/game/the-sims-4-keyart.jpg.adapt.crop1x1.767p.jpg"
              alt="The Sims 4" />
            <div className="game-in-nav-overlay">
              <img className="logo big-logo" alt="The Sims 4 logo"
